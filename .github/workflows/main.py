...
PATH_DOCUMENTI = [
    os.path.join("src", "candidatura", "Lettera di Presentazione", "lettera_presentazione.tex"),
    os.path.join("src", "candidatura", "Preventivo dei costi ed impegni orari", "preventivo_impegni.tex"),
    os.path.join("src", "candidatura", "Valutazione dei Capitolati", "valutazione_capitolati.tex"),
