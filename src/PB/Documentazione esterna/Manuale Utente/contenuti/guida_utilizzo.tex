...
% Parlare del fatto che i documenti vengono aggiornati automaticamente ogni 24 ore
% Descrivere il badge di segnalazione dell'esito dell'ultimo aggiornamento:
% - spunta se avvenuto con successo; 
% - X se fallito;
% - segnale di pericolo se non è stato possibile recuperare l'esito.
