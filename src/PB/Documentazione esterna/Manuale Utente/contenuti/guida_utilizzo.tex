...
Quando si refresha la pagina, la discussione viene ripristinata, mostrando i 50 messaggi più recenti. È possibile visualizzare i messaggi precedenti tramite scroll: se si tenta di risalire ai messaggi dello storico non ancora caricati dal sistema, verrà visualizzata un'icona di una banana morsicata che rotea su se stessa che ne segnala il caricamento in corso, come si può vedere in figura \bulref{fig:Icona di caricamento dei messaggi precedenti}. Terminata tale attesa verranno visualizzati i messaggi precedenti.\\
...
Una volta che ci si trova in alto nella conversazione, è possibile tornare velocemente ai messaggi più recenti cliccando sull'apposito pulsante che appare in basso a destra, visibile in \bulref{fig:Pulsante per tornare ai messaggi recenti}.
