...
L’applicazione web permette di porre domande inerenti all’ecosistema aziendale sfruttando un \emph{Large Language Model (LLM)}\textsubscript{\textbf{\textit{G}}}, 
