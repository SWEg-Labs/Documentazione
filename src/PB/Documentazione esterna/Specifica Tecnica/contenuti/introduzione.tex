...
\begin{itemize}
    \item \S\bulhref{https://www.math.unipd.it/~tullio/IS-1/2024/Progetto/C9.pdf}{Capitolato C9: BuddyBot}; \\
    \item \S\bulhref{https://sweg-labs.github.io/Documentazione/output/PB/Documentazione\%20interna/norme_progetto_v2.0.0.pdf}{Norme di Progetto v.2.0.0}; \\
    \item \S\bulhref{https://www.math.unipd.it/~tullio/IS-1/2024/Dispense/PD1.pdf}{Regolamento progetto didattico}; \\
\end{itemize}

\subsubsection{Riferimenti informativi}
\begin{itemize}
    \item \S\bulhref{https://sweg-labs.github.io/Documentazione/output/PB/Documentazione\%20esterna/glossario_v2.0.0.pdf}{Glossario v.2.0.0}; \\
\end{itemize}
