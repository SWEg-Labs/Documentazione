...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        \hline
        0.1.12 & 09-03-25 & Scritte le sezioni \S\bulref{sec:architettura_salvataggio_messaggi_storico} 
        e \S\bulref{sec:architettura_recupero_messaggi_storico} & Giacomo Loat & Riccardo Stefani\\
        \hline
