...
preventivi orari vicini al consuntivato nel corso dell'andamento del progetto. Questo è dovuto alla scarsa esperienza iniziale del team
nel preventivare il tempo necessario per lo svolgimento delle attività nella \emph{RTB}\textsubscript{\textbf{\textit{G}}}, che è migliorata nel corso della \emph{PB}\textsubscript{\textbf{\textit{G}}}. Il picco negativo si è manifestato nella seconda sprint, dove il team ha avuto difficoltà
...
il tempo necessario per lo svolgimento delle attività, riuscendo ad ottenere un valore di varianza nullo, corrispondente al valore ottimo, nella sesta e nell'ottava e ultima sprint della \emph{PB}.
...
peggiorati nel passaggio da \emph{RTB} a \emph{PB}, nonostante la varianza iraria sia rimasta quasi costante. In particolare, nella Sprint 5 il team ha avuto difficoltà nell'attività di progettazione, ed allora ha concentrato la maggioranza delle forze su quest'ultima, che rappresenta una delle attività più costose del progetto: ciò ha comportato un aumenti dei costi rispetto al preventivo, seppur non delle ore. Il team ha poi recuperato nella Sprint 6 e nella Sprint 7, dove il difetto è stato l'opposto: il team ha ottenuto un risparmio di budget rispetto al preventivo, poichè gli sforzi per la progettazione nella Sprint 5 hanno dato i loro frutti, consentendo di risparmiare tempo e denaro nelle sprint successive. Infine, nella Sprint 8, il team è riuscito a mantenere il budget preventivato, ottenendo un valore di varianza di budget pari a 0, e ciò dimostra l'acquisizione di esperienza da parte del team nel corso della \emph{PB}.
...
\begin{figure}[h!]
    ...
    \begin{minipage}{.4\textwidth}
        \centering
        \includegraphics[width=.8\linewidth]{placeholder.png}
