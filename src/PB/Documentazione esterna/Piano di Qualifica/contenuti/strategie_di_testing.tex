...
\begin{table}[h!]
    ...
    TA10 & Verificare che l'utente possa visualizzare un badge che segnala l'esito dell'ultimo aggiornamento del database vettoriale, in una delle seguenti forme:
    \begin{itemize}
...
\begin{table}[h!]
    ...
    \rowcolor[HTML]{FFD700}
    \textbf{Codice} & \textbf{Descrizione} & \textbf{Fonte} & \textbf{Stato} \\ \hline
    TA11 & Verificare che l'utente possa visualizzare un messaggio che spiega il badge che segnala l'esito dell'ultimo aggiornamento del database vettoriale, in una delle seguenti possibilità:
    \begin{itemize}
