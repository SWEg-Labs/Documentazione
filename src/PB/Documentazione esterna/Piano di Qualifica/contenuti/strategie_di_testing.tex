...
\begin{table}[h!]
    ...
    TU160 & Verifica che il metodo copySnippet di ChatMessagesComponent chiami il metodo navigator.clipboard.writeText e inserisca e poi rimuova opportanemente la classe CSS 'snippet-copied' all'icona di copia. &  \multicolumn{1}{c|}{\textcolor{green}{\ding{51}}} \\ \hline
