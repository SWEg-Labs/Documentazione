...
\begin{itemize}
    ...
    \item \textbf{Sottocasi d'uso}:
    \begin{itemize}
        \item \bulhyperlink{UC2.1}{UC2.1}: Visualizzazione del nome dei file da cui il sistema ha preso i dati per la risposta alla domanda.
    \end{itemize}
    \item \textbf{Scenario alternativo}:
    \begin{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Scenario alternativo}:
    \begin{enumerate}
        \item \bulhyperlink{UC14}{UC14}: Visualizzazione errore nel recupero del nome dei file utili per la risposta.
    \end{enumerate}
\end{itemize}

\hypertarget{UC14}{}
\subsubsection{UC14: Visualizzazione errore nel recupero del nome dei file utili per la risposta}
\begin{itemize}
    \item \textbf{Attori principali}: Utente;
    \item \textbf{Precondizioni}: L'utente ha visualizzato la risposta generata;
    \item \textbf{Trigger}: L'utente desidera visualizzare il nome dei file da cui il sistema ha preso i dati per la risposta alla domanda;
...
\begin{itemize}
    \item \textbf{Attori principali}: Utente;
    \item \textbf{Precondizioni}: Il sistema deve essere collegato a un database relazionale per memorizzare e recuperare lo storico delle sessioni della chat;
    ...
    \item \textbf{Sottocasi d'uso}:
    \begin{itemize}
        \item \bulhyperlink{UC8.1}{UC8.1}: Visualizzazione di una singola sessione nello storico.
    \end{itemize}
    \item \textbf{Scenario alternativo}:
    \begin{enumerate}
...
\hypertarget{UC8.1}{}
\subsubsection{UC8.1: Visualizzazione di una singola sessione nello storico}
\begin{itemize}
    \item \textbf{Attori principali}: Utente;
    \item \textbf{Precondizioni}: Il sistema deve essere collegato a un database relazionale per memorizzare e recuperare lo storico delle sessioni della chat;
    ...
    \begin{enumerate}
        \item L'utente avvia il sistema;
        \item Il sistema recupera i messaggi delle sessioni di chat tenutesi in passato dal database relazionale, e li stampa a schermo;
        \item L'utente visualizza una singola sessione di messaggi, cioè la chat tenutasi in un singolo periodo in cui l'applicazione
        è stata accesa e funzionante.
    \end{enumerate}
    \item \textbf{Sottocasi d'uso}:
    \begin{itemize}
        \item \bulhyperlink{UC8.1.1}{UC8.1.1}: Visualizzazione di un singolo messaggio nella sessione.
    \end{itemize}
\end{itemize}

\hypertarget{UC8.1.1}{}
\subsubsection{UC8.1.1: Visualizzazione di un singolo messaggio nella sessione}
\begin{itemize}
    \item \textbf{Attori principali}: Utente;
    \item \textbf{Precondizioni}: Il sistema deve essere collegato a un database relazionale per memorizzare e recuperare lo storico delle sessioni della chat;
    ...
    \item \textbf{Casi che ereditano}:
    \begin{itemize}
        \item \bulhyperlink{UC8.1.2}{UC8.1.2}: Visualizzazione messaggio dell'utente;
        \item \bulhyperlink{UC8.1.3}{UC8.1.3}: Visualizzazione messaggio del chatbot.
    \end{itemize}
\end{itemize}

\hypertarget{UC8.1.2}{}
\subsubsection{UC8.1.2: Visualizzazione messaggio dell'utente}
\begin{itemize}
    \item \textbf{Attori principali}: Utente;
    \item \textbf{Precondizioni}: Il sistema deve essere collegato a un database relazionale per memorizzare e recuperare lo storico delle sessioni della chat;
...
\hypertarget{UC8.1.3}{}
\subsubsection{UC8.1.3: Visualizzazione messaggio del chatbot}
\begin{itemize}
    \item \textbf{Attori principali}: Utente;
    \item \textbf{Precondizioni}: Il sistema deve essere collegato a un database relazionale per memorizzare e recuperare lo storico delle sessioni della chat;
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: Il sistema deve essere collegato a un database relazionale per memorizzare e recuperare lo storico delle sessioni della chat;
    \item \textbf{Trigger}: L'utente desidera visualizzare lo storico delle sessioni della chat;
    \item \textbf{Postcondizioni}: L'utente visualizza un messaggio di avviso che riferisce che c'è stato un errore nel recupero dello storico;
    \item \textbf{Scenario principale}: 
    \begin{enumerate}
        \item L'utente avvia il sistema;
        \item Il sistema ha riscontrato un problema nel recupero dello storico dal database relazionale;
        \item L'utente visualizza un messaggio di avviso che riferisce che c'è stato un errore nel recupero dello storico.
    \end{enumerate}
\end{itemize}
