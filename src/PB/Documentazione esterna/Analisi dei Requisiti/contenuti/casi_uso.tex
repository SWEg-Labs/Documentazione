...
\begin{itemize}
    ...
    \begin{enumerate}
        \item L'utente avvia il sistema;
        \item Il sistema recupera il messaggio inviato dall'utente dal database relazionale e lo mostra a schermo;
        \item L'utente visualizza il messaggio inviato da lui stesso nello storico della chat.
    \end{enumerate}
    \item \textbf{Eredita da}:
    \begin{itemize}
        \item \bulhyperlink{UC8.1}{UC8.1}: Visualizzazione singolo messaggio dello storico.
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item L'utente avvia il sistema;
        \item Il sistema recupera il messaggio inviato dal chatbot dal database relazionale e lo mostra a schermo;
        \item L'utente visualizza il messaggio inviato dal chatbot nello storico della chat.
    \end{enumerate}
    \item \textbf{Eredita da}:
    \begin{itemize}
        \item \bulhyperlink{UC8.1}{UC8.1}: Visualizzazione singolo messaggio dello storico.
...
\hypertarget{UC15}{}
\subsubsection{UC15: Visualizzazione di un badge che segnala il successo dell'ultimo aggiornamento del database vettoriale}
...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni}: L'utente visualizza un badge che lo informa se l'ultimo aggiornamento tentato è riuscito.;
    \item \textbf{Scenario principale}:
    \begin{enumerate}
        \item L'utente avvia l'applicazione;
    ...
    \item \textbf{Casi che ereditano}:
    \begin{itemize}
        \item \bulhyperlink{UC16}{UC16}: Visualizzazione successo dell'ultimo tentativo di aggiornamento del database;
        \item \bulhyperlink{UC17}{UC17}: Visualizzazione fallimento dell'ultimo tentativo di aggiornamento.
    \end{itemize}
\end{itemize}
