...
\begin{table}[h!]
    ...
    \end{tabularx}
    \caption{Requisiti funzionali pt.1}
\end{table}
...
\begin{table}[h!]
    ...
    \end{tabularx}
    \caption{Requisiti funzionali pt.2}
\end{table}
...
\begin{table}[h!]
    ...
    \end{tabularx}
    \caption{Requisiti funzionali pt.3}
\end{table}
...
\begin{table}[h!]
    ...
    ROF28 & Obbligatorio & Il sistema deve visualizzare i messaggi dell'utente presenti nello storico. & \bulhyperlink{UC8.2}{UC8.2} \\ \hline
    ROF29 & Obbligatorio & Il sistema deve visualizzare i messaggi del chatbot presenti nello storico. & \bulhyperlink{UC8.3}{UC8.3} \\ \hline
    RDF30 & Desiderabile & I messaggi del chatbot e dell'utente visualizzati devono essere distinguibili tra loro tramite una colorazione differente. & \bulhyperlink{UC8.2}{UC8.2}, \bulhyperlink{UC8.3}{UC8.3} \\ \hline
    \end{tabularx}
    \caption{Requisiti funzionali pt.4}
...
\begin{table}[h!]
    ...
    \bulhyperlink{UC1}{UC1} & ROF1, RZF26 \\ \hline
...
\begin{table}[h!]
    ...
    \end{tabularx}
    \caption{Tracciamento Requisito - Fonti pt.1}
\end{table}
...
\begin{table}[h!]
    ...
    ROF28 & \bulhyperlink{UC8.2}{UC8.2} \\ \hline
    ROF29 & \bulhyperlink{UC8.3}{UC8.3} \\ \hline
    ...
    \end{tabularx}
    \caption{Tracciamento Requisito - Fonti pt.2}
