...
\begin{tabularx}{\textwidth}{|p{2cm}|p{3cm}|X|p{4cm}|} \hline
    ...
    \textbf{Codice} & \textbf{Rilevanza} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
        ...
        RZF26 & Opzionale & Il sistema deve permettere all'utente di digitare una domanda libera in linguaggio naturale tramite una barra di input. & \bulhyperlink{UC18}{UC18} \\ \hline
    \end{tabularx}
...
\begin{tabularx}{\textwidth}{|p{2cm}|p{3cm}|X|p{4cm}|} \hline
    \rowcolor[HTML]{FFD700} 
    \textbf{Codice} & \textbf{Rilevanza} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
        RZF27 & Opzionale & Il sistema deve proporre all'utente una lista di possibili domande da porre la chatbot. & \bulhyperlink{UC19}{UC19} \\ \hline
        RZF28 & Opzionale & L'utente deve poter selezionare una delle domande proposte dal sistema, e inviarla come interrogazione al chatbot. & \bulhyperlink{UC19}{UC19} \\ \hline
        ROF29 & Obbligatorio & Il sistema deve visualizzare i messaggi dell'utente presenti nello storico. & \bulhyperlink{UC8.2}{UC8.2} \\ \hline
        ROF30 & Obbligatorio & Il sistema deve visualizzare i messaggi del chatbot presenti nello storico. & \bulhyperlink{UC8.3}{UC8.3} \\ \hline
        RDF31 & Desiderabile & I messaggi del chatbot e dell'utente visualizzati devono essere distinguibili tra loro tramite una colorazione differente. & \bulhyperlink{UC8.2}{UC8.2}, \bulhyperlink{UC8.3}{UC8.3} \\ \hline
    \end{tabularx}
...
\begin{table}[h!]
    ...
    \bulhyperlink{UC8.2}{UC8.2} & ROF29 \\ \hline
    \bulhyperlink{UC8.3}{UC8.3} & ROF30 \\ \hline
    \bulhyperlink{UC8.2}{UC8.2}, \bulhyperlink{UC8.3}{UC8.3} & RDF31 \\ \hline
    ...
    \bulhyperlink{UC19}{UC19} & RZF28 \\ \hline
...
\begin{table}[h!]
    ...
    RZF26 & \bulhyperlink{UC18}{UC18} \\ \hline
    RZF27 & \bulhyperlink{UC19}{UC19} \\ \hline
    RZF28 & \bulhyperlink{UC19}{UC19} \\ \hline
    ROF29 & \bulhyperlink{UC8.2}{UC8.2} \\ \hline
    ROF30 & \bulhyperlink{UC8.3}{UC8.3} \\ \hline
    RDF31 & \bulhyperlink{UC8.2}{UC8.2}, \bulhyperlink{UC8.3}{UC8.3} \\ \hline
