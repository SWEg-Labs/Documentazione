...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        ... & ... & ... & ... & ...\\
        \hline
        1.1.1 & 10-03-25 & Stesura stesura resoconto sesto periodo sezione \S\bulref{sec:sesto periodo} e stesura del preventivo e consuntivo riguardante il sesto periodo dedicato alla PB sezione \S\bulref{sec:prev_cons_sesto_periodo} & Federica Bolognini & Giacomo Loat \\
        \hline
        1.1.0 & 08-03-25 & Corretto un link del registro modifiche, corretto format elenchi puntati, corretto formato date & Giacomo Loat & Federica Bolognini \\
        \hline
        1.0.3 & 21-02-25 & Stesura stesura resoconto quinto periodo sezione \S\bulref{sec:quinto periodo} e stesura del preventivo e consuntivo riguardante il quinto periodo dedicato alla PB sezione \S\bulref{sec:prev_cons_quinto_periodo} & Federica Bolognini & Giacomo Loat \\
        \hline
