...
\end{table}
L'ottavo periodo, che va dal 20 marzo al 03 aprile 2025, è stato dedicato al completamento delle attività di finalizzazione e revisione del progetto. Gli obiettivi fissati per l'ottavo periodo includevano l'aggiornamento e il completamento della documentazione, oltre alla comunicazione al professor Cardin. Tra le principali attività, si è proceduto con l'aggiornamento del cruscotto di valutazione della qualità nel \emph{Piano di Qualifica}, l'inserimento delle immagini definitive dei diagrammi nella \emph{Specifica Tecnica}, la rilettura e la riverifica di tutti i documenti per correggere errori e migliorare la coerenza. Inoltre, è stato sistemato il README del \emph{repository} dell’\emph{MVP} su richiesta del \emph{proponente}, scritta la lettera di presentazione e redatta la presentazione per l’incontro con il professor Cardin.
