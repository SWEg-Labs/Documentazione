...
\item Aggiornamento del badge di segnalazione esito aggiornamento automatico lato {\emph{backend}}\textsubscript{\textit{\textbf{G}}} e lato {\emph{frontend}}\textsubscript{\textit{\textbf{G}}};
...
\end{itemize}
Abbiamo avviato la scrittura della \emph{Specifica Tecnica} e del \emph{Manuale Utente}, focalizzandoci sulla sezione "cosa chiedere e come chiederlo".
