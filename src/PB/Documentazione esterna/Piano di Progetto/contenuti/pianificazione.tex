...
Infine, il giorno mercoledì 19 marzo, al termine del periodo, abbiamo validato la \emph{demo}\textsubscript{\textbf{\textit{G}}} dell'\emph{MVP} assieme al \emph{proponente}, che ha approvato il lavoro svolto, consentendo quindi al team di considerare conclusa l'attività di programmazione.
