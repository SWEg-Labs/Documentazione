...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        ... & ... & ... & ... & ...\\
        \hline
        1.0.7 & 24-02-25 & Aggiunti i termini \bulhyperlink{sec:adapter}, \bulhyperlink{sec:business_logic}, \bulhyperlink{sec:componente software}, \bulhyperlink{sec:domain business model}, \bulhyperlink{sec:manutenibile}, \bulhyperlink{sec:mock}, \bulhyperlink{sec:scalabilità}, \bulhyperlink{sec:stub} & Davide Verzotto & ...\\
        \hline
