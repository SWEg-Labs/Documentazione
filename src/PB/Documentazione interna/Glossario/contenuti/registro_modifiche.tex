...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        ... & ... & ... & ... & ...\\
        \hline
        1.1.2 & 09-03-25 & Aggiunti il termine \bulhyperlink{sec:sql}{SQL} & Riccardo Stefani & Federica Bolognini\\
        \hline
    \end{tabular}
\end{table}
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        interno, quindi è utile a noi membri del gruppo & Riccardo Stefani & Federica Bolognini\\
        \hline
