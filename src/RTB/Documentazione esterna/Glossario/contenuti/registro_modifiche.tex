...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        \hline
        0.3.3 & 03-01-25 & Aggiunti i termini \bulhyperlink{sec:test_statici}{test statici} e \bulhyperlink{sec:test_dinamici}{test dinamici} & Filippo Righetto & Riccardo Stefani \\
        \hline
