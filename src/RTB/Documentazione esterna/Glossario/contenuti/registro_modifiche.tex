...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        \hline
        0.1.2 & 09-11-24 & Aggiunti i termini \hyperref[sec:ciclo_di_vita]{Ciclo di vita del software}, 
        \hyperref[sec:processo]{Processo}, \hyperref[sec:verifica]{Verifica} e \hyperref[sec:way_of_working]{Way of Working} 
