...
\begin{itemize}  
    ...
    \end{itemize}  
    \item Incremento della qualità tramite la fase di \emph{testing}
    \begin{itemize}  
        \item Definire indicatori di qualità per misurare l’efficacia del \emph{testing} e guidare eventuali miglioramenti.  
    \end{itemize}  
\end{itemize} 
...
La continuazione dello sviluppo del \emph{PoC} ha visto il quasi completamento dell'implementazione dei \emph{requisiti} obbligatori, lasciando in sospeso quelli opzionali e desiderabili.
Infine, è stato incrementato il livello di qualità attraverso la fase di \emph{testing}, con la definizione di indicatori di qualità per misurarne l'efficacia e guidare eventuali miglioramenti.

\newpage
\paragraph{Prospetto orario: }
Nel secondo periodo si è registrato un leggero superamento delle ore di lavoro rispetto a quanto preventivato, con un totale di 3 ore in eccesso per il gruppo.\\
...
\paragraph{Prospetto economico secondo periodo: 20/12/2024 - 03/01/2025: }
...
In dettaglio, il costo orario per ogni membro del team è stato applicato in base al ruolo svolto, con i costi totali che sono stati calcolati sommando le ore lavorate. \\
Il totale delle spese sostenute per il secondo periodo ammonta a 995€, con un saldo finale che riflette l'andamento positivo del progetto, nonostante gli aumenti orari in alcune aree.\\
Questo prospetto offre una visione chiara dell'impatto economico del periodo e consente di monitorare il progresso rispetto al budget complessivo del progetto.
...
I rischi occorso durante il terzo sono stati:
\begin{itemize}
    \item \S\bulref{sec:Complessità delle nuove tecnologie}{: Complessità delle nuove tecnologie}.
...
\end{itemize}
Un rischio che abbiamo identificato riguarda l'approfondimento di tecnologie e problemi non direttamente correlati al nostro progetto, come la questione di Docker.\\
Per risolverlo, ci siamo confrontati con l'azienda se Docker fosse un tema centrale del progetto e ci è stato confermato che, pur essendo una possibilità, non esula dagli obiettivi del progetto. Anzi, potrebbe favorire lo sviluppo.\\
