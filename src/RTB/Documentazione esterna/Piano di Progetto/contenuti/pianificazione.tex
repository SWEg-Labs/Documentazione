...
\end{table}
Nel secondo periodo di lavoro, che va dal 12 novembre al 5 dicembre 2024 e coincide con la prima \textit{sprint}, 
...
\begin{figure}[h] 
    \centering
    \includegraphics[width=\textwidth]{Burndown ideale- secondo periodo.jpg}
...
\begin{figure}[h] 
    \centering
    \includegraphics[width=\textwidth]{Diagramma di Gantt - prima parte.jpg}
    \caption{Diagramma di Gantt secondo periodo: prima parte} 
    \label{fig: Diagramma di Gantt secondo periodo: prima parte}
\end{figure}
\newpage
...
\begin{figure}[h] 
    \centering
    \includegraphics[width=\textwidth]{Diagramma di Gantt - seconda parte.jpg}
    \caption{Diagramma di Gantt secondo periodo: seconda parte} 
    \label{fig: Diagramma di Gantt secondo periodo: seconda parte}
\end{figure}
