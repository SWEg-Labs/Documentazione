...
\begin{figure}[h] 
    \centering
    \includegraphics[width=\textwidth]{Diagramma di Gantt-(prima parte)-primoperiodo.jpg}
...
\begin{figure}[h] 
    \centering
    \includegraphics[width=\textwidth]{Diagramma di Gantt-(seconda parte)-primoperiodo.jpg}
...
\begin{figure}[h] 
    \centering
    \includegraphics[width=\textwidth]{Diagramma di Gantt-(prima parte)-secondoperiodo.jpg}
...
\begin{figure}[h] 
    \centering
    \includegraphics[width=\textwidth]{Diagramma di Gantt-(seconda parte)-secondoperiodo.jpg}
