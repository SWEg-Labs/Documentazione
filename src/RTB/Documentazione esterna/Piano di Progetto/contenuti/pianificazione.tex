...
Il team SWEg Labs ha condotto un’analisi approfondita dei \textbf{\emph{capitolati}} proposti, valutandone con attenzione i vantaggi e gli svantaggi per individuare quello che meglio si adatta alle esigenze e alle competenze del gruppo. 
...
\item Glossario: Per i dettagli relativi al glossario, si rimanda alla sezione \S\bulref{sec:glossario}.
\end{itemize}