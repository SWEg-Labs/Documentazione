...
\begin{itemize}
    \item \textbf{Attori principali}: Utente;
    \item \textbf{Precondizioni}: Il sistema ha generato una risposta valida con dello \emph{snippet} di codice al suo interno;
...
\begin{figure}[h]
    ...
    \caption{UC8: Visualizzare una risposta generata con dati di contesto provenienti da 
    \emph{GitHub}\textsubscript{\textbf{\textit{G}}}, \emph{Jira}\textsubscript{\textbf{\textit{G}}} e 
    \emph{Confluence}\textsubscript{\textbf{\textit{G}}}}
\end{figure}
...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{\emph{Trigger}\textsubscript{\textbf{\textit{G}}}}: L'utente desidera visualizzare una risposta basata sui dati di contesto provenienti da \emph{GitHub}, \emph{Jira} e \emph{Confluence};
    ...
    \begin{enumerate}
        ...
        \item \bulhyperlink{U8.2}{UC8.2}: Recupero dati da Jira.
...
\hypertarget{UC8.2}{}
\subsubsubsection{UC8.2: Recupero dati da Confluence}
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Trigger}: L'utente desidera visualizzazione i file da cui il sistema ha preso i dati per la risposta alla domanda;
