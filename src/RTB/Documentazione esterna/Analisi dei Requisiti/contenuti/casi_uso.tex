...
\begin{itemize}
    ...
    \item \textbf{Scenario alternativo}:
    \begin{enumerate}
        \item \bulhyperlink{UC10}{UC10}: Errore nel recupero dello storico.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Sottocasi d'uso}:
    \begin{itemize}
        \item \bulhyperlink{UC13.1}{UC13.1}: Visualizzare una singola domanda ideale per proseguire la conversazione.
    \end{itemize}
    \item \textbf{Scenario alternativo}:
    \begin{enumerate}
