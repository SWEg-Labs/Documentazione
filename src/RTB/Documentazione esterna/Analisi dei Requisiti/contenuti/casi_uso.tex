...
\begin{itemize}
    ...
    \item \textbf{Postcondizioni}: L'interrogazione viene inviata.
    ...
    \begin{enumerate}
        ...
        \item \bulhyperlink{UC1.3}{UC1.3}: Il sistema mostra il messaggio generato nella schermata principale.
    \end{enumerate}
    \item \textbf{\emph{Sottocasi d'uso}\textsubscript{\textbf{\textit{G}}}}:
    \begin{itemize}
        \item \bulhyperlink{UC1.1}{UC1.1}: L'utente scrive l'interrogazione in linguaggio naturale nella barra di input.
        \item \bulhyperlink{UC1.2}{UC1.2}: L'utente invia l'interrogazione tramite il pulsante dedicato o "Invio" dalla tastiera.
        \item \bulhyperlink{UC1.3}{UC1.3}: Visualizzazione del messaggio appena scritto nella videata principale.
    \end{itemize}
\end{itemize}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{UC2.1+UC15.png}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item \bulhyperlink{UC2}{UC2}: Visualizzare una risposta generata con dati di contesto provenienti da \emph{GitHub}, \emph{Jira} e \emph{Confluence}.
    ...
    \item \textbf{Scenario alternativo}:
    \begin{enumerate}
        \item \bulhyperlink{UC15}{UC15}: Visualizzazione errore nella rilevazione dei file utili per la risposta.
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item L'utente visualizzerà in fondo al messaggio di risposta una segnalazione di errore che comunica che non è stato possibile rilevare i file da cui è stata ricavata la risposta;
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Trigger}: L'utente desidera visualizzare i log di aggiornamento del database vettoriale;
    ...
    \begin{enumerate}
        ...
        \item Il sistema recupera i log di aggiornamento del database vettoriale;
        \item L'utente visualizza i log di aggiornamento del database vettoriale.
    \end{enumerate}
    \item \textbf{Scenario alternativo}:
    \begin{enumerate}
        \item \bulhyperlink{UC17}{UC17}: Visualizzazione errore nel recupero dei log di aggiornamento del database vettoriale;
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Precondizioni}: L'utente ha avviato l'app;
    \item \textbf{Trigger}: L'utente desidera visualizzare i log di aggiornamento del database vettoriale;
    \item \textbf{Postcondizioni}: L'utente visualizza un segnale di errore segnalante l'impossibilità di recuperare i log;
    \item \textbf{Scenario principale}:
    \begin{enumerate}
        \item L'utente clicca il pulsante per il recupero dei log;
        \item Il sistema non riesce a recuperare i log di aggiornamento del database vettoriale;
        \item L'utente visualizza un messaggio di errore che invita riprovare più tardi.
    \end{enumerate}
\end{itemize}
