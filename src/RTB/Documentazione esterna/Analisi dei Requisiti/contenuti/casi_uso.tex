...
\hypertarget{UC11.1}{}
\subsubsubsection{UC11.1: Chiamata \emph{API}\textsubscript{\textbf{\textit{G}}} verso GitHub per il recupero di eventuali nuove modifiche}
\begin{itemize}
...
\hypertarget{UC11.4}{}
\subsubsubsection{UC11.4: \emph{Merge}\textsubscript{\textbf{\textit{G}}} dei nuovi dati con i dati già presenti nel database vettoriale}
\dots
