...
\hypertarget{UC8.1}{}
\subsubsubsection{UC8.1: Recupero dati da \emph{GitHub}}
\begin{itemize}
...
\hypertarget{UC8.2}{}
\subsubsubsection{UC8.2: Recupero dati da \emph{Jira}}
\begin{itemize}
...
\hypertarget{UC8.3}{}
\subsubsubsection{UC8.3: Recupero dati da \emph{Confluence}}
\begin{itemize}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{Diagramma UC10.png}
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item L'utente accede all'interfaccia dell'applicazione;
        \item \bulhyperlink{UC1}{UC1}: Inserimento di interrogazione in linguaggio naturale;
        \item \bulhyperlink{UC10.1}{UC10.1}: Recupero dati da \emph{Telegram};
        \item \bulhyperlink{UC10.2}{UC10.2}: Recupero dati da \emph{Slack}.
    \end{enumerate}
    \item \textbf{Sottocasi d'uso}:
    \begin{itemize}
        \item \bulhyperlink{UC10.1}{UC10.1}: Recupero dati da \emph{Telegram};
...
\hypertarget{UC10.1}{}
\subsubsubsection{UC10.1: Recupero dati da \emph{Telegram}}
\begin{itemize}
...
\hypertarget{UC10.2}{}
\subsubsubsection{UC10.2: Recupero dati da \emph{Slack}}
\begin{itemize}
