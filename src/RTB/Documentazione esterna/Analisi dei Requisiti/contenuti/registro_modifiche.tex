...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|p{5cm}|p{3cm}|p{3cm}|}
        ...
        \hline
        0.3.13 & 10-01-25 & Risistemazione Requisiti funzionali \S\bulref{sec:requisiti_funzionali}, tracciamento Requisiti-Fonte \S\bulref{sec:requisito_fonte} e Fonte-Requisiti \S\bulref{sec:fonte_requisito} & Davide Verzotto & \\
