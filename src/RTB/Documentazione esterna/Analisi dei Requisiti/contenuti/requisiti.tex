...
\begin{tabularx}{\textwidth}{|p{2cm}|p{3cm}|X|p{4cm}|} \hline
    ...
    \textbf{Codice} & \textbf{Rilevanza} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
        ...
        RZF21 & Opzionale & Il sistema deve comunicare se l'ultimo tentativo di aggiornare il database vettoriale ha avuto successo o meno. & \bulhyperlink{UC15}{UC15}, \bulhyperlink{UC16}{UC16}, \bulhyperlink{UC17}{UC17} \\ \hline
