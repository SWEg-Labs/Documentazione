...
\begin{table}[h!]
    ...
    \rowcolor[HTML]{FFD700} 
    \textbf{Codice} & \textbf{Rilevanza} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
    ROI1 & Obbligatorio & Il sistema deve processare i documenti che vengono caricati, creandone i loro embedding & Proponente\\ \hline
    ROI2 & Obbligatorio & Il sistema deve salvare, in modo persistente, i documenti caricati a sistema & Proponente\\ \hline
    ROI3 & Obbligatorio & Il sistema deve salvare, in modo persistente, tutte le informazioni relative ai documenti presenti a sistema & Proponente\\ \hline
