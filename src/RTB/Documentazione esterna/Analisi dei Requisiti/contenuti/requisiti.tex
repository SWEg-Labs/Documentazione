...
\begin{table}[h!]
    ...
    \label{tab:Requisiti_qualitattivi}
\end{table}
...
Trattandosi di una applicazione \emph{web}\textsubscript{\textit{\textbf{G}}}, i requisiti prestazionali saranno influenzati principalmente dalla connessione Internet, 
