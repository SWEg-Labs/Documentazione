...
\begin{table}[h!]
    ...
    ROF3 & Obbligatorio & Nel caso il sistema fallisca nel generare una risposta per via di un problema intenrno, deve far visualizzare all'utente un messaggio di errore, chiedendo di riprovare più tardi. & \bulhyperlink{UC2}{UC2}, \bulhyperlink{UC3}{UC3} \\ \hline
    ...
    ROF5 & Obbligatorio & Nel caso il sistema non riesca a trovare le informazioni richieste dall'utente, deve rispondere all'utente spiegando la mancanza dell'informazione richiesta. & \bulhyperlink{UC2}{UC2}, \bulhyperlink{UC5}{UC5} \\ \hline
    ...
    RDF7 & Desiderabile & Nel caso l'utente desideri accedere ai file utilizzati per genereare la risposta ma questo non sia possibile, deve essere visualizzato un messaggio di errore. &\bulhyperlink{UC14}{UC14} \\ \hline
    \end{tabularx}
    \end{table}
...
\begin{tabularx}{\textwidth}{|p{2cm}|p{3cm}|X|p{4cm}|} \hline
    ...
    \textbf{Codice} & \textbf{Rilevanza} & \textbf{Descrizione} & \textbf{Fonti} \\ \hline
        ...
        RZF21 & Opzionale & Il sistema deve comunicare o meno se il database vettoriale a cui vengono poste le interrogazioni è aggiornato o meno. & \bulhyperlink{UC15}{UC15}, \bulhyperlink{UC16}{UC16}, \bulhyperlink{UC17}{UC17} \\ \hline
\end{tabularx}
