...
\begin{itemize}
    ...
    \item Tipologia:
        \begin{itemize} 
            ...
            \item P: requisito prestazionale che definisce le metriche di performance che il sistema deve soddisfare, come tempi di risposta, capacità di elaborazione e scalabilità, per garantire il funzionamento corretto. 
        \end{itemize}
