...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{\S\bulhref{https://sweg-labs.github.io/Documentazione/output/Candidatura/lettera_presentazione_v1.0.0.pdf}{Lettera di Presentazione (v1.0.0)}}: documento con cui il gruppo \emph{SWEg Labs} si
        candida formalmente per la realizzazione del progetto commissionato;
        \item \textbf{\S\bulhref{https://sweg-labs.github.io/Documentazione/output/Candidatura/preventivo_impegni_v1.0.0.pdf}{Preventivo dei costi e degli impegni orari (v1.0.0)}}: documento che contiene 
        ...
        \item \textbf{\S\bulhref{https://sweg-labs.github.io/Documentazione/output/Candidatura/valutazione_capitolati_v1.0.0.pdf}{Valutazione dei Capitolati (v1.0.0)}}
    ...
    \begin{itemize}
        \item \textbf{\S\bulhref{https://sweg-labs.github.io/Documentazione/output/RTB/lettera_presentazione.pdf}{Lettera di Presentazione (v1.0.0)}}: documento con cui il gruppo \emph{SWEg Labs} si
        candida formalmente per la revisione RTB;
